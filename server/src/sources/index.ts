...
import { ciclicoWebSource } from "./ciclico.js";

// Lista única de fuentes. Agregar una nueva = sumarla acá.
export const sources: DataSource[] = [dolarSource, datosGobSource, cammesaSource, tickerSource, climaSource, ciclicoWebSource];
